...
while(True):
    ...
    ret, im_th = cv2.threshold(im_gray, 100, 255, cv2.THRESH_BINARY_INV)    # Threshold the image
    ...
    #dilation = cv2.dilate(im_th,(3,3),iterations = 1)
    ...
    for rect in rects:
        ...
        cv2.putText(im, str(int(nbr[0]))+' '+str(color), (rect[0], rect[1]),cv2.FONT_HERSHEY_DUPLEX, 2, (0, 255, 255), 3)
